...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-x86asm --disable-avdevice --disable-avfilter --enable-pthreads --enable-static --enable-pic --enable-runtime-cpudetect --prefix=/Users/admin/workspace/playercore/native/ffmpeg/ffmpeg-3.4.2/../ffmpeg-dev-out --disable-linux-perf --enable-debug
...
EXTRALIBS=-framework CoreFoundation -framework VideoToolbox -framework CoreMedia -framework CoreVideo -framework VideoDecodeAcceleration -liconv -Wl,-framework,CoreFoundation -Wl,-framework,Security -lm  -lbz2 -lz -pthread -pthread -framework CoreServices -framework CoreGraphics -framework VideoToolbox -framework CoreImage -framework AVFoundation -framework AudioToolbox -framework AppKit 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
