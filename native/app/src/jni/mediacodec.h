...
struct mc_api
{
    ...
    void (*clean)(mc_api *);
    int (*configure)(mc_api *, const char *psz_name);
    ...
    int (*dequeue_in)(mc_api *, int64_t i_timeout);
    int (*dequeue_out)(mc_api *, int64_t i_timeout);
